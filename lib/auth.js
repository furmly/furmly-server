...
UserManager.prototype.login = function(domain, client, username, password, fn) {
	var self = this;
	this.checkPassword(domain, client, username, password, function(er, user) {
		if (er) return fn(er);
...
UserManager.prototype.checkPassword = function(
	domain,
	client,
	username,
	password,
...
UserManager.prototype.getRoles = function(query, fn) {
	this.roleStore.getRoles(query, fn);
};
